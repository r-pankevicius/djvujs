...
if (process.env.NODE_ENV !== 'production') {
    window.addEventListener('load', () => {
        ...
        //window.DjVuViewerInstance.loadDocumentByUrl("http://localhost/djvuMap/api/RealEstate/AktDirekt/2/RealEstate.SV/AktDirektDocument?county=06&document=06-GID-451");
